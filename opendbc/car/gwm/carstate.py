...
class CarState(CarStateBase):
  ...
  def update(self, can_parsers) -> tuple[structs.CarState, structs.CarStateSP]:
    ...
    # NOTE: upstream's informational CarState.brake is deprecated in sunnypilot's car.capnp, so the
    # BRAKE/BRAKE_PRESSURE readout is not published here. Nothing in the port consumes it.
