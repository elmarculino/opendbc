...
class CarControllerParams:
  ...
  # sunnypilot keeps the v1/v2 angle-limit dataclasses split (AngleSteeringLimits / AngleSteeringLimitsVM);
  # upstream opendbc merged them. We take the vehicle-model path, so use the VM variant here.
